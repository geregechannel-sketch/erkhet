  ...
  mn: {
    shortcuts: [
      ...
      },
      {
        ...
        body: "Хийсэн захиалга, төлбөрийн бичлэг, төлөвөө account болон booking center-ээс хянаарай.",
        href: "/booking-payment",
      },
      {
        title: "10 алхамт төлөвлөлт",
        body: "Зорилго, чиглэл, төсөв, нэмэлт үйлчилгээний хэрэгцээгээ шат дараатай илгээх custom enquiry урсгал.",
        href: "/enquire/step/1",
      },
    ],
