  ...
  mn: {
    ...
    sections: [
      ...
      },
      {
        ...
        summary: "Очих газрын баталгаа, аяллын хөтөлбөр, буудал болон нислэгийн захиалгаа уялдуулна.",
        details: [
          "Захиалгат аялал бол манай багаас аяллын хөтөлбөр болон дэмжих бичгээ урьдчилж авна.",
          "Хил дээр асууж магадгүй тул аяллын хөтөлбөр, захиалгын дугаараа хэвлэж эсвэл PDF-ээр хадгална.",
        ],
      },
      {
        id: "timeline",
        ...
        details: [
          "Ачаалал ихтэй улирал, баярын үе, олон улсын үзэсгэлэн, амралтын өдрүүдэд визийн хугацаа уртсаж болдог.",
      ...
      },
      {
        ...
        summary: "Банкны тодорхойлолт, ажлын тодорхойлолт, аяллын даатгал шаардлагатай эсэхээ шалгана.",
        details: [
          "Зарим улс дансны үлдэгдэл, цалингийн орлого, ивээн тэтгэгчийн тодорхойлолт шаардаж болдог.",
      ...
      },
      {
        ...
        details: [
          "Визгүй, цахим виз, хил дээрх виз, ярилцлагын шаардлага зэрэг нөхцөл богино хугацаанд өөрчлөгдөж болно.",
    ...
    officialLabel: "Элчин сайдын яам, консулын газар, цахим визийн сайтыг давхар шалгаарай.",
  ...
  ru: {
    ...
    sections: [
      ...
      },
      {
        id: "proof",
        title: "Подтверждения",
        summary: "Согласуйте приглашение, маршрут, бронирование отеля и авиабронь.",
        details: [
          "Для индивидуальных поездок мы можем заранее подготовить подтверждающие документы по маршруту.",
          "Храните маршрут и номера бронирования в PDF или распечатанном виде.",
        ],
      },
      {
        id: "timeline",
      ...
      },
      {
        ...
        summary: "Уточните, нужны ли банковские выписки, справка с работы и туристическая страховка.",
        details: [
          "Некоторые страны требуют выписки, подтверждение дохода или спонсорское письмо.",
      ...
      },
      {
        ...
        details: [
          "Правила безвизового режима, электронной визы, визы по прибытии и интервью могут меняться быстро.",
    ...
    officialLabel: "Проверьте посольство, консульство и портал электронной визы нужной страны.",
  ...
  zh: {
    ...
    sections: [
      ...
      },
      {
        ...
        details: [
          "定制行程时，我们可以提前准备行程支持文件。",
          "建议将行程单与预订编号保留 PDF 或打印件。",
        ],
      },
      {
        id: "timeline",
    ...
    officialLabel: "请同时查看目的地使馆、领馆和电子签证网站。",
    contactButton: "获取建议",
    backButton: "返回指南",
  },
};
